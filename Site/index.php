				...
				<li class="bg-dark">
					...
					<div class="hs-caption container">
						<div class="caption-content">
							...
							<div class="hs-title-size-1">
								<a href="#" class="btn btn-primary btn-round btn-lg">View more</a>
							</div>
						</div>
					</div>
		...
		<section class="module-small">
			...
			<div class="container">
				...
				<div class="row">
					...
					<h2 class="module-title font-alt align-center">About Hall Street</h2>
					<div class="col-sm-6 col-sm-offset-3">
							<p class="align-center">The languages only differ in their grammar, their pronunciation and their most common words. Everyone realizes why a new common language would be desirable: one could refuse to pay expensive translators.</p>
					</div>
